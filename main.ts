...
function create_sprite_raimon(): Sprite {
    let sprite3 = sprites.create(img`ddddddbbbbbbbbcccccccbbbbbbbbbcffccbddbccfffffffcbbccfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffccccccccccccccccccccccccccccccccccccccc
...
function create_sprite_infierno(): Sprite {
    let sprite3 = sprites.create(img`fffffffcffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffefffffeecfffffcfffffffffffffffffffffffffffff222effffffffffffffcffffffffffffffffff
...
function create_sprite_menu(): Sprite {
    let sprite3 = sprites.create(img`fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffcccccceeeeeeeeccccccbbbbd1ddd111111111111d1dddddddddddddddd111111d11111111111111dd111dddddbb
...
function cinematica() {
    ...
    let sprite3 = create_sprite_raimon()
    sprite3.setPosition(81, 20)
