...
def create_sprite_raimon():
    sprite3 = sprites.create(img("""ddddddbbbbbbbbcccccccbbbbbbbbbcffccbddbccfffffffcbbccfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffccccccccccccccccccccccccccccccccccccccc
...
def create_sprite_infierno():
    sprite3 = sprites.create(img("""fffffffcffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffefffffeecfffffcfffffffffffffffffffffffffffff222effffffffffffffcffffffffffffffffff
...
def create_sprite_menu():
    sprite3 = sprites.create(img("""fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffcccccceeeeeeeeccccccbbbbd1ddd111111111111d1dddddddddddddddd111111d11111111111111dd111dddddbb
...
def cinematica():
    ...
    game.show_long_text("RAÚL: QUEEEEEE??? LO NECESITO PARA ACCEDER A LA UNIVERSIDAD !! YA NO ERES EL MEJOR PROFE QUE HE TENIDO...",
        DialogLayout.BOTTOM)
    sprite3 = create_sprite_raimon()
    sprite3.set_position(81, 20)
    ...
    game.show_long_text("RAIMON: PORQUE DIOS?? QUE HE HECHO YO PARA MERECER ESTO?? DESEO VENDER MI ALMA A CAMBIO DE CONVERTIRME EN EL MEJOR PROFESOR QUE PUEDAN TENER !!",
            DialogLayout.BOTTOM)
    sprite3 = create_sprite_infierno()
    sprite3.set_position(81, 60)
    ...
    game.show_long_text("DIABLO: JAJAJA verás, querías ser el mejor profesor que puedan tener a cambio de tu alma. Pero hay un pequeño detalle, ya lo eres! Por lo tanto tu alma me pertenece...",
            DialogLayout.BOTTOM)
    game.show_long_text("RAIMON: Ya lo soy? En serio?",
            DialogLayout.BOTTOM)
