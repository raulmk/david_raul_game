...
def help2():
    ...
    sprite34 = sprites.create(assets.image("""
        logo
    """), SpriteKind.Fondo)
    sprite34.change_scale(2, ScaleAnchor.MIDDLE)
    sprite34.set_position(80, 45)
...
def level_game_cntrl():
    global mySprite, lava_level, sprite52, sprite34
    if level_game == 1:
        ...
        sprite52.set_scale(1, ScaleAnchor.MIDDLE)
        ...
        sprite52 = create_sprite_dios()
        sprite52.set_scale(1, ScaleAnchor.MIDDLE)
        game.show_long_text("DIOS: LO SÉ... RECUERDO TUS LLANTOS DE FELICIDAD CUANDO EL BARÇA GANÓ EL SEXTETE. ERES UN FIEL CREYENTE POR ESO TE ABRÍ LAS PUERTAS DEL CIELO.",
            DialogLayout.BOTTOM)
        sprites.destroy(sprite52)
        sprite34 = create_sprite_raimon()
        sprite34.set_position(81, 20)
